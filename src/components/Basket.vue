                  ...
                  <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                    <div class="flex justify-between w-full pt-1">
                      <div class="flex border border-2 rounded">
                        ...
                        <button @click="increment(product.id)"><svg class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
              <div>
                ...
                <div class="flex items-center justify-between pt-16">
                  ...
                  <p class="text-base leading-none text-gray-800">{{ totalPrice() + "€"}}</p>
                </div>
                <div class="flex items-center justify-between pt-5">
                  <p class="text-base leading-none text-gray-800">Shipping</p>
                  <p class="text-base leading-none text-gray-800">5€</p>
                </div>
                <div class="flex items-center justify-between pt-5">
                  <p class="text-base leading-none text-gray-800">Tax</p>
                  <p class="text-base leading-none text-gray-800">3€</p>
                </div>
              </div>
              <div>
                <div class="flex items-center pb-6 justify-between lg:pt-5 pt-20">
                  <p class="text-2xl leading-normal text-gray-800">Total</p>
                  <p v-if="!totalPrice()" class="text-2xl font-bold leading-normal text-right text-gray-800">{{ totalPrice() + "€"}}</p>
                  <p v-else class="text-2xl font-bold leading-normal text-right text-gray-800">{{ totalPrice() + 8 + "€"}}</p>
                </div>
